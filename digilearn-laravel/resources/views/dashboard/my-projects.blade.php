...
<head>
    ...
    <title>My Projects - {{ config('app.name', 'ShoutOutGh') }}</title>
    ...
    <style>
        ...
        * {
        ...
        .stat-icon.completed { background-color: var(--success-green); }
        .stat-icon.in-progress { background-color: var(--warning-yellow); }
