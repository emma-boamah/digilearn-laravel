        ...
        <div class="container">
            <div class="header-content">
                <div class="header-left">
                    <button class="back-button" onclick="window.location.href='{{ route('dashboard.university.programs') }}'">
    ...
    <div class="main-content">
        <div class="container">
            ...
            <div class="courses-grid">
                ...
                <div class="course-card" onclick="window.location.href='{{ route('dashboard.university.course.lessons', $course['id']) }}'">
