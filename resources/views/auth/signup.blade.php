            ...
            <form method="POST" action="{{ route('signup.submit') }}" id="signupForm">
                ...
                <div class="form-group">
                    <label for="phone" class="form-label" style="display: flex; justify-content: space-between; align-items: center;">
                        <span>Phone Number <span class="optional-indicator">(Optional)</span></span>
                        <button type="button" class="rules-toggle-btn" style="padding: 0; margin: 0; font-size: 0.8rem;" onclick="document.getElementById('privacyNotice').style.display = document.getElementById('privacyNotice').style.display === 'none' ? 'block' : 'none'">
                            <i class="fas fa-info-circle"></i> Why we ask for this?
                        </button>
                    </label>
                    
                    <!-- Privacy Notice -->
                    <div class="privacy-notice" id="privacyNotice" style="display: none; margin-top: 0.5rem;">
