    ...
    <div class="form-card">
        <form method="POST" action="{{ route('school.studio.video.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" class="form-input" value="{{ old('title') }}" required placeholder="e.g. Introduction to Algebra">
                @error('title') <span class="error-text">{{ $message }}</span> @enderror
            </div>

            <div class="form-group">
                <label class="form-label">Video URL (YouTube/Vimeo)</label>
                <input type="url" name="external_video_url" class="form-input" value="{{ old('external_video_url') }}" required placeholder="https://youtube.com/watch?v=...">
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-textarea" placeholder="Brief description of what students will learn...">{{ old('description') }}</textarea>
