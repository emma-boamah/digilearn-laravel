                                            ...
                                            @if($content->average_rating)
                                                <div class="flex items-center gap-1">
                                                    <div class="flex items-center">
                                                        @for($i = 1; $i <= 5; $i++)
                                                            <svg class="w-4 h-4 {{ $i <= $content->average_rating ? 'text-yellow-400' : 'text-gray-300' }}"
                                                    ...
                                                    <span class="text-sm text-gray-600 ml-1">{{ $content->average_rating }}
                                                        ({{ $content->total_ratings }})</span>
                                                </div>
                                            @else
