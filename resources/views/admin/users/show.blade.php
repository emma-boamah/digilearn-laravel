    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div>
                    <div class="flex items-center space-x-3">
                        ...
                        @if($user->is_superuser)
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-purple-100 text-purple-800 uppercase tracking-wider">Super Admin</span>
                        @elseif($user->is_verified)
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-blue-100 text-blue-800 uppercase tracking-wider">Admin</span>
                        @else
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-800 uppercase tracking-wider">Student</span>
                        @endif
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="p-6">
                        <div class="flex items-start space-x-8">
                            ...
                            <div class="flex-shrink-0 relative">
                                ...
                                <form id="avatar-upload-form" enctype="multipart/form-data" class="absolute bottom-0 right-0">
                                    ...
                                    <button type="button" id="avatar-upload-button" title="Change Avatar" class="bg-gray-700 text-white rounded-full p-1.5 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 shadow-sm">
                            ...
                            <div class="flex-1 grid grid-cols-2 gap-x-12 gap-y-5">
                                ...
                                <div>
                                    ...
                                    <p class="text-base font-medium text-gray-900">
                                        @if($user->city && $user->country)
                                            <i class="fas fa-map-marker-alt text-blue-500 mr-1"></i>{{ $user->city }}, {{ $user->country }}
                                        @elseif($user->country)
                                ...
                                <!-- Education Level -->
                                <div>
                                    <label class="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Education Level</label>
                                    <p class="text-base font-medium text-gray-900">
                                ...
                                <!-- Current Grade -->
                                <div>
                                    <label class="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Current Grade</label>
                                    <p class="text-base font-medium text-gray-900">
                                ...
                                <div>
                                    <label class="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Age</label>
                                    <p class="text-base font-medium text-gray-900">{{ \Carbon\Carbon::parse($user->date_of_birth)->age }} years old</p>
                                </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="mt-6 pt-6 border-t border-gray-200">
                            <label class="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Bio</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="px-3 py-2 bg-red-50 rounded-lg border border-red-100">
                                    <p class="text-xs text-red-600"><span class="font-semibold">Reason:</span> {{ $user->suspension_reason }}</p>
                                </div>
                                @endif
                                ...
                                <div class="flex items-center justify-between p-3 bg-red-50 rounded-lg border border-red-100">
                                    ...
                                    <span class="text-xs text-red-500">Until {{ $user->locked_until->format('M d, Y H:i') }}</span>
                                </div>
                                @endif
                            </div>
                            ...
                            <div>
                                <div class="bg-gray-50 rounded-xl border border-gray-200 p-5">
                                    <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-4">Last Login Information</h3>
                                    <div class="grid grid-cols-3 gap-4">
                                        <div>
                                            <label class="block text-xs font-medium text-gray-500 mb-1">IP Address</label>
                                            <p class="text-sm font-semibold text-gray-900 font-mono">{{ $user->last_login_ip ?? 'N/A' }}</p>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            <label class="block text-xs font-medium text-gray-500 mb-1">Failed Attempts</label>
                                            <p class="text-sm font-semibold text-gray-900">{{ $user->failed_login_attempts ?? 0 }}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 bg-gray-50 rounded-xl border border-gray-200 p-5">
                                    <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-4">Registration Details</h3>
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            <label class="block text-xs font-medium text-gray-500 mb-1">Registration IP</label>
                                            <p class="text-sm font-semibold text-gray-900 font-mono">{{ $user->registration_ip ?? 'N/A' }}</p>
                                        </div>
                                        <div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-4">
                                            ...
                                            @php
                                                ...
                                                switch($activity->type) {
                                                    ...
                                                    case 'user_registration':
                                                        ...
                                                        if($activity->type === 'user_registration') $iconClass = 'fa-user-plus text-green-600';
                                                        break;
                                                    case 'user_logout':
                                                    ...
                                                    case 'quiz_access':
                                                        ...
                                                        if($activity->type === 'quiz_access') $iconClass = 'fa-question-circle text-blue-600';
                                                        break;
                                                    case 'payment_action':
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <p class="text-[10px] font-bold text-gray-400 font-mono tracking-tight uppercase">IP: {{ $activity->ip_address }}</p>
                                        </div>
                                    </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            @php
                                ...
                                if (preg_match('/(\d+)\s*hour/i', $watchTime, $hMatches) && preg_match('/(\d+)\s*minute/i', $watchTime, $mMatches)) {
                                    $h = (int)$hMatches[1];
                                    $m = (int)$mMatches[1];
                                    $formattedWatchTime = number_format($h + ($m / 60), 1) . 'h';
                                } else {
                                    $formattedWatchTime = str_replace([' hours', ' minutes', ' hour', ' minute'], ['h', 'm', 'h', 'm'], $watchTime);
                                }
                            ...
                            <div class="bg-blue-50 rounded-xl p-6 text-center">
                                <div class="text-3xl font-bold text-blue-700 mb-2">{{ $lessonProgress['completed_lessons'] ?? 0 }}</div>
                                <div class="text-[9px] font-bold text-blue-400 uppercase tracking-wider whitespace-nowrap">Lessons Completed</div>
                            </div>
                            
                            <!-- Completion Rate -->
                            <div class="bg-green-50 rounded-xl p-6 text-center">
                                <div class="text-3xl font-bold text-green-700 mb-2">{{ $lessonProgress['completion_rate'] ?? 0 }}%</div>
                                <div class="text-[9px] font-bold text-green-400 uppercase tracking-wider whitespace-nowrap">Completion Rate</div>
                            </div>
                            
                            <!-- Watch Time -->
                            <div class="bg-gray-50 rounded-xl p-6 text-center">
                                <div class="text-3xl font-bold text-gray-700 mb-2">{{ $formattedWatchTime }}</div>
                                <div class="text-[9px] font-bold text-gray-400 uppercase tracking-wider whitespace-nowrap">Watch Time</div>
                            </div>
                            
                            <!-- Favorite Subject -->
                            <div class="bg-indigo-50 rounded-xl p-6 text-center">
                                <div class="text-2xl font-bold text-blue-700 mb-2 truncate" title="{{ $lessonProgress['favorite_subject'] ?? 'N/A' }}">
                                    {{ $favSubject }}
                                </div>
                                <div class="text-[9px] font-bold text-indigo-400 uppercase tracking-wider whitespace-nowrap">Favorite Subject</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    <div class="p-5">
                        <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-4">Subscription Plan</h3>
                        @if($user->currentSubscription)
                            ...
                            <div class="flex items-center p-3 bg-gray-50 rounded-xl border border-gray-100">
                                ...
                                <div class="ml-3 flex-1 min-w-0">
                                    <p class="text-sm font-bold text-gray-900">{{ $subscription->pricingPlan->name ?? 'Unknown Plan' }}</p>
                        ...
                        @else
                            <div class="flex items-center p-3 bg-gray-50 rounded-xl border border-gray-100">
                                ...
                                <div class="w-7 h-7 rounded-full bg-blue-600 flex items-center justify-center flex-shrink-0 cursor-pointer hover:bg-blue-700 transition-colors" title="Assign plan">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    <div class="p-5">
                        <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-4">Current Status</h3>
                        <div class="flex items-center space-x-4">
                            @if($user->is_online)
                            ...
                            @else
                                ...
                                <div>
                                    ...
                                    @if($user->last_activity_at)
                                        <p class="text-xs text-gray-400">Last active {{ $user->last_activity_at->diffForHumans() }}</p>
                                    @else
                    ...
                    <div class="p-5">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                ...
                                <span class="text-sm font-semibold text-gray-900 font-mono">{{ $user->registration_ip }}</span>
                            </div>
                            @endif
                            ...
                            <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                ...
                                <span class="text-sm font-semibold text-gray-900 font-mono">{{ $user->last_login_ip }}</span>
                            </div>
                            @endif
                            ...
                            <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                ...
                                <span class="text-sm font-semibold text-gray-900">
                                    <span class="text-xs text-gray-400 font-mono mr-1">{{ strtoupper(substr($user->country, 0, 2)) }}</span>
                                    {{ $user->country }}
                                </span>
                            </div>
                            @endif
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    <div class="p-5">
                        <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-4">Quick Admin Actions</h3>
                        <div class="space-y-2.5">
                            <button onclick="sendMessage()" class="w-full flex items-center px-4 py-3 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors text-sm font-semibold text-blue-700 border border-blue-100">
                                <i class="fas fa-envelope text-blue-500 mr-3 text-base"></i>Send Message
                            </button>
                            <button onclick="resetPassword()" class="w-full flex items-center px-4 py-3 bg-yellow-50 rounded-xl hover:bg-yellow-100 transition-colors text-sm font-semibold text-yellow-700 border border-yellow-100">
                                <i class="fas fa-key text-yellow-600 mr-3 text-base"></i>Reset Password
                            </button>
                            <button onclick="viewLoginHistory()" class="w-full flex items-center px-4 py-3 bg-green-50 rounded-xl hover:bg-green-100 transition-colors text-sm font-semibold text-green-700 border border-green-100">
                                <i class="fas fa-history text-green-500 mr-3 text-base"></i>Login History
                            </button>
                            <button onclick="impersonateUser()" class="w-full flex items-center px-4 py-3 bg-purple-50 rounded-xl hover:bg-purple-100 transition-colors text-sm font-semibold text-purple-700 border border-purple-100">
            ...
            <div class="modal-header border-b border-gray-100 p-6 flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider mt-0.5">To: {{ $user->name }}</p>
                    </div>
                </div>
                <button type="button" class="text-gray-400 hover:text-gray-600 transition-colors focus:outline-none" data-dismiss="modal" data-bs-dismiss="modal">
                ...
                <div class="modal-body p-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div class="space-y-2">
                            ...
                            <select class="block w-full px-4 py-3 rounded-xl border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500/10 bg-white" name="notification_type_id" id="userNotificationTypeSelect" required>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" class="block w-full px-4 py-3 rounded-xl border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500/10 bg-white" name="title" placeholder="Enter notification title..." required>
                        </div>
                    </div>

                    <div class="space-y-2 mb-6">
                        <label class="block text-sm font-bold text-gray-700">Message</label>
                        <textarea class="block w-full px-4 py-3 rounded-xl border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500/10 bg-white" name="message" rows="4" placeholder="Type your message here..." required></textarea>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div class="space-y-2">
                            <label class="block text-sm font-bold text-gray-700">URL <span class="text-xs font-normal text-gray-400">(Optional)</span></label>
                            <input type="url" class="block w-full px-4 py-3 rounded-xl border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500/10 bg-white" name="url" placeholder="https://example.com/...">
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center space-x-6">
                                <label class="flex items-center text-sm font-medium text-gray-700 cursor-pointer">
                                    <input type="checkbox" name="channels[]" value="database" id="userDatabase" checked class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 mr-2">
                                    In-App
                                </label>
                                <label class="flex items-center text-sm font-medium text-gray-700 cursor-pointer">
                                    <input type="checkbox" name="channels[]" value="mail" id="userMail" class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 mr-2">
                                    Email
                                </label>
                                <label class="flex items-center text-sm font-medium text-gray-700 cursor-pointer">
                                    <input type="checkbox" name="channels[]" value="broadcast" id="userBroadcast" class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 mr-2">
                                    Real-time
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="p-4 bg-blue-50/50 rounded-xl border border-blue-100/50" id="userNotificationPreview">
                        <div class="flex items-center text-blue-700">
                            ...
                            <span class="text-sm font-semibold italic"><strong>Preview:</strong> Select a notification type to see preview</span>
                        </div>
                    </div>
                </div>

                <div class="modal-footer border-t border-gray-100 p-6 space-x-3">
                    <button type="button" class="px-6 py-2.5 bg-gray-100 text-gray-700 rounded-xl font-bold text-sm hover:bg-gray-200 transition-colors" data-dismiss="modal">Cancel</button>
                    <button type="submit" class="px-6 py-2.5 bg-blue-600 text-white rounded-xl font-bold text-sm hover:bg-blue-700 shadow-lg shadow-blue-500/25 transition-all flex items-center">
