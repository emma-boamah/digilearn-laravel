...
<div class="top-header">
    ...
    <div class="header-center" id="headerCenter">
        ...
        <!-- Search Box -->
        <div class="header-search" data-search-domain="{{ $searchDomain ?? 'lesson' }}">
            <svg class="header-search-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
            <input type="text" class="header-search-input search-input" id="globalSearchInput" placeholder="Search lessons, subjects...">
        </div>
    </div>
    @endif
