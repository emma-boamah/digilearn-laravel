        ...
        <div class="sidebar-scrollable">
            <div class="sidebar-section">
                ...
                <a href="{{ route('dashboard.main') }}"
                    ...
                    <span class="sidebar-menu-text">
                        <span class="full-label">Learning Hub</span>
                        <span class="short-label">Home</span>
                    </span>
                ...
                <a href="{{ route('dashboard.library') }}"
                    class="sidebar-menu-item {{ request()->routeIs('dashboard.library*') || request()->routeIs('dashboard.documents*') ? 'active' : '' }}">
                    <svg class="sidebar-menu-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="sidebar-section">
                ...
                <a href="/dashboard/my-progress"
                    ...
                    <span class="sidebar-menu-text">
                        <span class="full-label">My Progress</span>
                        <span class="short-label">Progress</span>
                    </span>
                ...
                <a href="/dashboard/saved-lessons"
                    ...
                    <span class="sidebar-menu-text">
                        <span class="full-label">Saved Lessons</span>
                        <span class="short-label">Saved</span>
                    </span>
                ...
                <a href="/dashboard/my-projects"
                    ...
                    <span class="sidebar-menu-text">
                        <span class="full-label">My Projects</span>
                        <span class="short-label">Projects</span>
                    </span>
                ...
                <a href="{{ route('dashboard.notes') }}"
                    ...
                    <span class="sidebar-menu-text">
                        <span class="full-label">My Notes</span>
                        <span class="short-label">Notes</span>
                    </span>
                    <div class="tooltip">My Notes</div>
                </a>
                <a href="{{ route('dashboard.agent') }}"
                    class="sidebar-menu-item ai-tutor-premium {{ request()->routeIs('dashboard.agent') ? 'active' : '' }}">
                    <svg class="sidebar-menu-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('dashboard.join-class') }}"
                    ...
                    <span class="sidebar-menu-text">
                        <span class="full-label">Join Your Class</span>
                        <span class="short-label">Classes</span>
                    </span>
                    <span class="badge bg-red-500" id="classAlertBadge"></span>
                    <div class="tooltip">Join Your Class</div>
                </a>
                <a href="{{ route('dashboard.change-level') }}"
                    ...
                    <span class="sidebar-menu-text">
                        <span class="full-label">Change Level</span>
            ...
            <div class="sidebar-section">
                ...
                <a href="{{ route('dashboard.notifications') }}"
                    ...
                    <span class="sidebar-menu-text">
                        <span class="full-label">Notifications</span>
                        <span class="short-label">Alerts</span>
                    </span>
                ...
                <a href="{{ route('settings.billing') }}"
                    ...
                    <span class="sidebar-menu-text">
                        <span class="full-label">Subscription &amp; Billing</span>
                        <span class="short-label">Billing</span>
                    </span>
