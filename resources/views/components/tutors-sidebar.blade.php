        ...
        <div class="sidebar-scrollable">
            <div class="sidebar-section">
                ...
                <a href="{{ route('dashboard.main') }}"
                    ...
                    <span class="sidebar-menu-text"><span class="full-label">Learning Hub</span><span class="short-label">Home</span></span>
            ...
            <div class="sidebar-section">
                ...
                <a href="{{ route('tutors.index') }}"
                    ...
                    <span class="sidebar-menu-text"><span class="full-label">Find Tutors</span><span class="short-label">Tutors</span></span>
                ...
                @if(!auth()->user()->tutorProfile)
                    <a href="{{ route('tutors.apply') }}"
                        ...
                        <span class="sidebar-menu-text"><span class="full-label">Become a Tutor</span><span class="short-label">Apply</span></span>
                ...
                @else
                    <a href="{{ route('tutors.dashboard') }}"
                        ...
                        <span class="sidebar-menu-text"><span class="full-label">Tutor Overview</span><span class="short-label">Overview</span></span>
                    ...
                    <a href="{{ route('tutors.bookings.index') }}"
                        ...
                        <span class="sidebar-menu-text"><span class="full-label">Bookings Manager</span><span class="short-label">Bookings</span></span>
                    ...
                    <a href="{{ route('tutors.content.index') }}"
                        ...
                        <span class="sidebar-menu-text"><span class="full-label">Content Studio</span><span class="short-label">Studio</span></span>
                    ...
                    <a href="{{ route('tutors.earnings.index') }}"
                        ...
                        <span class="sidebar-menu-text"><span class="full-label">Wallet & Earnings</span><span class="short-label">Wallet</span></span>
                    ...
                    <a href="{{ route('tutors.analytics.index') }}"
                        ...
                        <span class="sidebar-menu-text"><span class="full-label">Analytics</span><span class="short-label">Analytics</span></span>
                    ...
                    <a href="{{ route('tutors.profile.settings') }}"
                        ...
                        <span class="sidebar-menu-text"><span class="full-label">Profile Settings</span><span class="short-label">Settings</span></span>
            ...
            <div class="sidebar-section">
                ...
                <a href="{{ route('settings.billing') }}"
                    ...
                    <span class="sidebar-menu-text"><span class="full-label">Subscription & Billing</span><span class="short-label">Billing</span></span>
