...
@if(!$hasConsent)
    ...
    <div id="cookie-consent-banner" x-data="cookieConsentBanner()" x-show="showBanner">
        ...
        <div class="cookie-banner-body" :class="{ 'expanded': showDetails }">
            <div class="cookie-banner-body-inner">
                <!-- Location Permission Notice -->
                <div x-show="showLocationPrompt" x-transition class="location-notice">
                    <strong>Location Permission:</strong> Your browser may ask to share your location for better localized
                    services (optional).
                </div>
                ...
                <div class="cookie-categories">
                    @foreach($categories as $key => $description)
                        <div class="cookie-category">
                            <input type="checkbox" id="cookie-{{ $key }}" class="cookie-checkbox"
                                x-model="selectedCookies.{{ $key }}" @if($key === 'preference' || $key === 'consent') disabled checked
                                @endif>
