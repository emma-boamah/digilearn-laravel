...
@section('description', 'ShoutOutGH is Ghana\'s premier online learning platform offering interactive lessons, quizzes,
and educational resources for students from primary to tertiary level. Access quality online education in Ghana.')
@section('keywords', 'online education in ghana, online school ghana, education ghana, school, e-learning ghana, digital
learning platform, online classes ghana, ShoutOutGH, JHS lessons, SHS lessons, university courses ghana, BECE
preparation, WASSCE preparation, free online school ghana')
...
<meta property="og:description"
    content="Access quality online education in Ghana. Interactive lessons, quizzes, and study materials for Primary, JHS, SHS, and University students.">
...
<style nonce="{{ request()->attributes->get('csp_nonce') }}">
    ...
    @keyframes pulse-blue {
        0% {
            box-shadow: 0 0 0 0 rgba(0, 140, 255, 0.8);
        }

        70% {
            box-shadow: 0 0 0 25px rgba(0, 140, 255, 0);
        }
    ...
    .resources-main-title {
        ...
        letter-spacing: 0.02em;
        width: 70%;
        /* Control width to force natural 2-line break */
        word-spacing: 0.05em;
    }
    ...
    <div class="hero-content">
        <div class="hero-text">
            ...
            <div class="hero-actions">
                <a href="{{ route('signup') }}" class="hero-btn"
                    style="background-color: #008cffff; color: #f9fbfcff; font-weight: 700; font-family: 'Work Sans', sans-serif; text-transform: uppercase; letter-spacing: 0.05em; border: none; box-shadow: 0 4px 14px 0 rgba(0, 136, 255, 0.39);">
                    Get Started
                </a>
            </div>
...
<main role="main">
    ...
    <section class="section bg-white" aria-labelledby="why-choose-title" itemscope
        itemtype="https://schema.org/Service">
        <div class="container">
            <div class="why-choose">
                <div class="why-choose-text">
                    <p class="tools-on-shoutout">Tools on ShoutoutGh</p>
                    <h2 id="why-choose-title" class="text-3xl font-bold mb-6" itemprop="name">Why Choose ShoutOutGh?
                    </h2>
                    <p class="discover-innovative-features" itemprop="description">
                        Discover innovative features, designed to simplify your study process and maximize your academic
                        success.
                    </p>
                    <hr class="hr">
                    <ul class="feature-list" itemscope itemtype="https://schema.org/ItemList">
                        ...
                        <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                            ...
                            <span itemprop="name">Creative and engaging video content to enhance your understanding of
                                complex topics</span>
                        </li>
                        <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
        ...
        <div class="container">
            ...
            <header class="pricing-header-new">
                <div class="pricing-header-content-new">
                    <div class="pricing-text-center">
                        ...
                        <p class="pricing-subtitle">Select your membership plan tailored to your needs.<br>customize
                            your subscription for a seamless fit.</p>
                    ...
                    <div class="pricing-image-right">
                        <img src="{{ secure_asset('images/student-laptop.png') }}"
                            alt="Student learning on laptop with ShoutOutGH platform" loading="lazy">
                    </div>
                </div>
            </header>
            ...
            <div class="pricing-grid {{ $pricingPlans->count() === 1 ? 'single-card' : '' }}" @if($pricingPlans->count()
                ...
                <article class="pricing-card" role="listitem">
                    ...
                    <div class="pricing-badge {{ strtolower(str_replace(' ', '-', $plan->name)) }}">{{ $plan->name }}
                    </div>
                    <div class="pricing-body">
                        <p class="pricing-description">{{ $plan->description ?? 'Comprehensive learning package with
                            access to all platform features.' }}</p>
                        ...
                        <a href="{{ route('pricing-details') }}" class="pricing-btn-new"
                            aria-label="Get started with {{ $plan->name }} plan">Get Started</a>
                    </div>
                </article>
                @empty
            ...
            <div class="testimonials-slider-wrapper" x-data="{ 
                ...
                <div class="testimonials-grid" role="list" aria-label="Student testimonials" x-ref="slider">
                    ...
                    <article class="testimonial-card" role="listitem" itemscope itemtype="https://schema.org/Review">
                        ...
                        <div class="testimonial-author" itemprop="author" itemscope
                            itemtype="https://schema.org/Person">
                            <img src="{{ secure_asset($testimonial['image']) }}"
                                alt="Photo of {{ $testimonial['name'] }}" loading="lazy" itemprop="image">
